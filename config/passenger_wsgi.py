"""
WSGI config for chnl_expl_project.
...
## vars
ACTIVATE_FILE = os.path.abspath( u'%s/../../env27_chnl_expl/bin/activate_this.py' % current_directory )
PROJECT_DIR = os.path.abspath( u'%s/../../chnl_expl_project' % current_directory )
PROJECT_ENCLOSING_DIR = os.path.abspath( u'%s/../..' % current_directory )
SETTINGS_MODULE = u'config.settings'
SITE_PACKAGES_DIR = os.path.abspath( u'%s/../../env27_chnl_expl/lib/python2.7/site-packages' % current_directory )
...
## load up env vars
SETTINGS_FILE = os.environ['CHNNLS__SETTINGS_PATH']  # set in activate_this.py, and activated above
import shellvars
